  ...
  return (
    ...
    <div>
      ...
      <div className="flex justify-center  flex-col items-center">
        <div className="con" > <div className="con11     mt-4 "> </div>
          <div className="con2 w-full h-400 items-end flex rounded-xl">
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Learn how to preprocess and clean data for analysis and
                      modeling.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Dive into the world of EDA and learn how to extract
                      insights from data.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      ...
                      instructors. Get hands-on experience in an
